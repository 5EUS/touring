...
impl ::core::fmt::Debug for Media {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    f.debug_struct("Media").field("id", &self.id).field("mediatype", &self.mediatype).field("title", &self.title).field("description", &self.description).field("url", &self.url).finish()
  }
}
...
impl ::core::fmt::Debug for Episode {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    f.debug_struct("Episode").field("id", &self.id).field("title", &self.title).field("number", &self.number).field("url", &self.url).finish()
  }
}
...
impl ::core::fmt::Debug for Mediastream {
  fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
    f.debug_struct("Mediastream").field("url", &self.url).field("quality", &self.quality).field("mime", &self.mime).finish()
  }
}
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_fetchmangalist_cabi<T: Guest>(arg0: *mut u8,arg1: usize,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
...
pub unsafe fn __post_return_fetchmangalist<T: Guest>(arg0: *mut u8,) { unsafe {
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_fetchchapterimages<T: Guest>(arg0: *mut u8,) { unsafe {
  let l0 = *arg0.add(0).cast::<*mut u8>();
  let l1 = *arg0.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
  let base4 = l0;
  let len4 = l1;
...
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_fetchanimelist_cabi<T: Guest>(arg0: *mut u8,arg1: usize,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
_rt::run_ctors_once();let result1 = {
  let len0 = arg1;
  let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_fetchanimelist<T: Guest>(arg0: *mut u8,) { unsafe {
  let l0 = *arg0.add(0).cast::<*mut u8>();
  let l1 = *arg0.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
  let base15 = l0;
  let len15 = l1;
...
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_fetchanimeepisodes_cabi<T: Guest>(arg0: *mut u8,arg1: usize,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
_rt::run_ctors_once();let result1 = {
  let len0 = arg1;
  let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
...
let vec7 = result1;
let len7 = vec7.len();
let layout7 = _rt::alloc::Layout::from_size_align(vec7.len() * (8+7*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>()).unwrap();
...
for (i, e) in vec7.into_iter().enumerate() {
  ...
  {
    let Episode{ id:id3, title:title3, number:number3, url:url3, } = e;
    let vec4 = (id3.into_bytes()).into_boxed_slice();
    let ptr4 = vec4.as_ptr().cast::<u8>();
    let len4 = vec4.len();
    ::core::mem::forget(vec4);
    ...
    *base.add(2*::core::mem::size_of::<*const u8>()).cast::<*mut u8>() = ptr5.cast_mut();
    match number3 {
      Some(e) => {
        ...
        *base.add(4+4*::core::mem::size_of::<*const u8>()).cast::<f32>() = _rt::as_f32(e);
      },
      None => {
        {
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_fetchanimeepisodes<T: Guest>(arg0: *mut u8,) { unsafe {
  let l0 = *arg0.add(0).cast::<*mut u8>();
  let l1 = *arg0.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
  let base9 = l0;
  let len9 = l1;
...
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_fetchepisodestreams_cabi<T: Guest>(arg0: *mut u8,arg1: usize,) -> *mut u8 { unsafe {#[cfg(target_arch="wasm32")]
_rt::run_ctors_once();let result1 = {
  let len0 = arg1;
  let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
...
let vec7 = result1;
let len7 = vec7.len();
let layout7 = _rt::alloc::Layout::from_size_align(vec7.len() * (8*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>()).unwrap();
let (result7, _cleanup7) = wit_bindgen::rt::Cleanup::new(layout7);if let Some(cleanup) = _cleanup7 { cleanup.forget(); }
for (i, e) in vec7.into_iter().enumerate() {
  let base = result7.add(i * (8*::core::mem::size_of::<*const u8>()));
  {
    let Mediastream{ url:url3, quality:quality3, mime:mime3, } = e;
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_fetchepisodestreams<T: Guest>(arg0: *mut u8,) { unsafe {
  let l0 = *arg0.add(0).cast::<*mut u8>();
  let l1 = *arg0.add(::core::mem::size_of::<*const u8>()).cast::<usize>();
  let base10 = l0;
  let len10 = l1;
  ...
  _rt::cabi_dealloc(base10, len10 * (8*::core::mem::size_of::<*const u8>()), ::core::mem::size_of::<*const u8>());
} }
pub trait Guest {
