...
impl ::core::fmt::Debug for UnitKind {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        match self {
            UnitKind::Chapter => f.debug_tuple("UnitKind::Chapter").finish(),
            UnitKind::Episode => f.debug_tuple("UnitKind::Episode").finish(),
            UnitKind::Section => f.debug_tuple("UnitKind::Section").finish(),
            UnitKind::Other(e) => f.debug_tuple("UnitKind::Other").field(e).finish(),
        }
    }
}
#[derive(Clone)]
...
impl ::core::fmt::Debug for Unit {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("Unit")
            .field("id", &self.id)
            .field("title", &self.title)
            .field("number-text", &self.number_text)
            .field("number", &self.number)
            .field("lang", &self.lang)
            .field("group", &self.group)
            .field("url", &self.url)
            .field("published-at", &self.published_at)
...
impl ::core::fmt::Debug for AssetKind {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        match self {
            AssetKind::Page => f.debug_tuple("AssetKind::Page").finish(),
            AssetKind::Image => f.debug_tuple("AssetKind::Image").finish(),
            AssetKind::Audio => f.debug_tuple("AssetKind::Audio").finish(),
            AssetKind::Video => f.debug_tuple("AssetKind::Video").finish(),
            AssetKind::Subtitle => f.debug_tuple("AssetKind::Subtitle").finish(),
            AssetKind::File => f.debug_tuple("AssetKind::File").finish(),
            AssetKind::Other(e) => f.debug_tuple("AssetKind::Other").field(e).finish(),
        }
    }
}
#[derive(Clone)]
...
impl ::core::fmt::Debug for ProviderCapabilities {
    fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
        f.debug_struct("ProviderCapabilities")
            .field("media-types", &self.media_types)
            .field("unit-kinds", &self.unit_kinds)
            .field("asset-kinds", &self.asset_kinds)
            .finish()
    }
}
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_fetchmedialist_cabi<T: Guest>(
    arg0: i32,
    arg1: *mut u8,
    arg2: usize,
    arg3: *mut u8,
    ...
    unsafe {
        ...
        let vec12 = result3;
        let len12 = vec12.len();
        let layout12 = _rt::alloc::Layout::from_size_align(
            vec12.len() * (16 * ::core::mem::size_of::<*const u8>()),
            ::core::mem::size_of::<*const u8>(),
        )
        .unwrap();
        let (result12, _cleanup12) = wit_bindgen::rt::Cleanup::new(layout12);
        if let Some(cleanup) = _cleanup12 {
            cleanup.forget();
        }
...
pub unsafe fn __post_return_fetchmedialist<T: Guest>(arg0: *mut u8) {
    unsafe {
...
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_fetchunits_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> *mut u8 {
    unsafe {
        #[cfg(target_arch = "wasm32")]
        _rt::run_ctors_once();
        let result1 = {
        ...
        let len12 = vec12.len();
        let layout12 = _rt::alloc::Layout::from_size_align(
            vec12.len() * (8 + 22 * ::core::mem::size_of::<*const u8>()),
            ::core::mem::size_of::<*const u8>(),
        )
        .unwrap();
        let (result12, _cleanup12) = wit_bindgen::rt::Cleanup::new(layout12);
        ...
        for (i, e) in vec12.into_iter().enumerate() {
            let base = result12.add(i * (8 + 22 * ::core::mem::size_of::<*const u8>()));
            {
                let Unit {
                    id: id3,
                    title: title3,
                    number_text: number_text3,
                    number: number3,
                    lang: lang3,
                    group: group3,
                    url: url3,
                    published_at: published_at3,
                    kind: kind3,
                } = e;
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_fetchunits<T: Guest>(arg0: *mut u8) {
    unsafe {
        let l0 = *arg0.add(0).cast::<*mut u8>();
        let l1 = *arg0
            .add(::core::mem::size_of::<*const u8>())
        ...
        _rt::cabi_dealloc(
            base24,
            len24 * (8 + 22 * ::core::mem::size_of::<*const u8>()),
            ::core::mem::size_of::<*const u8>(),
        );
    }
}
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_fetchassets_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> *mut u8 {
    unsafe {
        #[cfg(target_arch = "wasm32")]
        _rt::run_ctors_once();
        let result1 = {
        ...
        let layout7 = _rt::alloc::Layout::from_size_align(
            vec7.len() * (16 + 8 * ::core::mem::size_of::<*const u8>()),
            ::core::mem::size_of::<*const u8>(),
        )
        .unwrap();
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_fetchassets<T: Guest>(arg0: *mut u8) {
    unsafe {
        let l0 = *arg0.add(0).cast::<*mut u8>();
        let l1 = *arg0
            .add(::core::mem::size_of::<*const u8>())
        ...
        _rt::cabi_dealloc(
            base10,
            len10 * (16 + 8 * ::core::mem::size_of::<*const u8>()),
            ::core::mem::size_of::<*const u8>(),
        );
    }
}
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_getcapabilities_cabi<T: Guest>() -> *mut u8 {
    unsafe {
        #[cfg(target_arch = "wasm32")]
        _rt::run_ctors_once();
        let result0 = { T::getcapabilities() };
        let ptr1 = (&raw mut _RET_AREA.0).cast::<u8>();
        let ProviderCapabilities {
            media_types: media_types2,
            unit_kinds: unit_kinds2,
            asset_kinds: asset_kinds2,
        } = result0;
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_getcapabilities<T: Guest>(arg0: *mut u8) {
    unsafe {
        let l0 = *arg0.add(0).cast::<*mut u8>();
        let l1 = *arg0
            .add(::core::mem::size_of::<*const u8>())
