...
#[doc(hidden)]
#[allow(non_snake_case, unused_unsafe)]
pub unsafe fn _export_fetchmangachapterlist_cabi<T: Guest>(arg0: *mut u8, arg1: usize) -> *mut u8 {
    unsafe {
        #[cfg(target_arch = "wasm32")]
        _rt::run_ctors_once();
        let result1 = {
...
#[doc(hidden)]
#[allow(non_snake_case)]
pub unsafe fn __post_return_fetchmangachapterlist<T: Guest>(arg0: *mut u8) {
    unsafe {
        let l0 = *arg0.add(0).cast::<*mut u8>();
        let l1 = *arg0
            .add(::core::mem::size_of::<*const u8>())
